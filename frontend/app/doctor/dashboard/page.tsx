    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="container mx-auto px-4">
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden mb-8">
          <h2 className="text-xl font-semibold p-4 bg-gray-100">My Visits With Other Doctors</h2>
          {visitingAppointments.length === 0 ? (
            <p className="p-4 text-gray-600">No visits booked</p>
          ) : (
              ...
              <tbody>
                {visitingAppointments.map((apt) => (
                  <tr key={apt.id} className="border-t">
                    ...
                    <td className="px-4 py-3">${apt.fees || 0}</td>
                    <td className="px-4 py-3">
